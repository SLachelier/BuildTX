      ...
      .then(function (data) {
        ...
        for (let i = 0; i < data.features.length; i++) {
          if (
            ...
            "Construction begins within 4 years" && data.features[i].properties.DISTRICT_NAME === "Pharr" && data.features[i].properties.NBR_LET_YEAR === 2023 && data.features[i].properties.NBR_LET_MONTH === 1
          ) {
            ...
            <br></br>
              // document.querySelector(".january").innerHTML = data.features[i].properties.DISTRICT_NAME;
